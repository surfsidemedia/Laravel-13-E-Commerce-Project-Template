...
<body class="bg-gray-100 font-sans antialiased">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        ...
                        <div class="space-y-6">
                            ...
                            <div class="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
                                ...
                                <div id="new-image-preview-container" class="grid grid-cols-3 gap-2 mb-6">
                                    </div>

                                <h4 class="text-sm font-medium text-gray-700 mb-3 border-b pb-1">Existing Images</h4>
                                <div class="grid grid-cols-3 gap-2" id="existing-images-container">
                                    ...
                                    <div class="existing-image-wrapper relative group h-20 bg-gray-100 rounded border overflow-hidden">
                                        ...
                                        <div class="remove-existing-btn absolute inset-0 bg-black bg-opacity-50 hidden group-hover:flex items-center justify-center cursor-pointer text-white transition-opacity" data-image="product-01.jpg">
                                    ...
                                    <div class="existing-image-wrapper relative group h-20 bg-gray-100 rounded border overflow-hidden">
                                        ...
                                        <div class="remove-existing-btn absolute inset-0 bg-black bg-opacity-50 hidden group-hover:flex items-center justify-center cursor-pointer text-white transition-opacity" data-image="product-02.jpg">
                                            <i class="fa-solid fa-trash pointer-events-none"></i>
                                        </div>
                                    </div>
                                ...
                                <div id="deleted-existing-images"></div>
                            </div>
                        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // ==========================================
            // 2. MULTIPLE NEW IMAGE UPLOAD & PREVIEW
            // ==========================================
            const imageInput = document.getElementById('product-images');
            const previewContainer = document.getElementById('new-image-preview-container');
            let selectedFiles = []; // Array to store our selected files
            ...
            function updateFileInputAndPreviews() {
                // Sync the HTML input with our tracking array
            ...
            // ==========================================
            // 3. REMOVE EXISTING IMAGES (TRACK FOR BACKEND)
            // ==========================================
            const removeExistingBtns = document.querySelectorAll('.remove-existing-btn');
            const deletedImagesContainer = document.getElementById('deleted-existing-images');
            ...
            removeExistingBtns.forEach(btn => {
                btn.addEventListener('click', function() {
                    ...
                    // Create a hidden input so PHP knows to delete this image on submit
                    const hiddenInput = document.createElement('input');
                    hiddenInput.type = 'hidden';
                    hiddenInput.name = 'deleted_existing_images[]';
